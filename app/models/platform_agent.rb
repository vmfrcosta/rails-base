...
class PlatformAgent
  ...
  # Desktop browsers are considered compatibility browser due to limited support to the webshare api and service workers
  def compatibility_browser?
    @compatibility ||= supported_browsers.detect { |browser| user_agent <= browser } || match?(/SamsungBrowser/) || desktop?
  end
